export const SITE_CONFIG = {
  ...
  phone: "919014827770",
  phoneDisplay: "090148 27770",
  phone2: "917893116525",
  phone2Display: "078931 16525",
  email: "info@winevbikerentals.in",
  address: {
    street: "8-8-2/3/4, Road No. 2",
    area: "Thapovan Colony, Green Park Colony, Saroor Nagar East",
    city: "Hyderabad",
    state: "Telangana",
    pin: "500079",
    full: "8-8-2/3/4, Road No. 2, Thapovan Colony, Green Park Colony, Saroor Nagar East, Hyderabad, Telangana 500079"
  },
  ...
  keywords: [
    ...
    "EV scooter rental hyderabad", 
    "electric scooter rent hyderabad", 
    "scooter rental saroor nagar",
    "winev scooter rental", 
    "ashwin traders scooter rental"
  ],
};
